...
TESTS
2395 / 2395 PASS across 137 files against a real local PostgreSQL 16.10 (up from 209 in the cloud
environment), measured 2026-08-28 on the ask-guardrail architecture branch after the ESC-015
exact-cover redesign -- 2378 passing plus 17 pinned `it.fails`, which are reproduced defects this
