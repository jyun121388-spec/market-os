...
TESTS
2321 / 2321 PASS across 131 files against a real local PostgreSQL 16.10 (up from 209 in the cloud
environment), measured 2026-08-28 on the ask-guardrail architecture branch after the ESC-015
exact-cover redesign -- 2307 passing plus 14 pinned `it.fails`, which are reproduced defects this
