...
TESTS
2686 / 2686 PASS across 152 files against a real local PostgreSQL 16.10 (up from 209 in the cloud
environment) -- 2667 passing plus 19 pinned `it.fails`. REMOTE CI run 33547628222, bound to
