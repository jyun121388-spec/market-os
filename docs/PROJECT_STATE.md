...
TESTS
2716 / 2716 PASS across 154 files against a real local PostgreSQL 16.10 (up from 209 in the cloud
environment) -- 2697 passing plus 19 pinned `it.fails`, which are reproduced defects deliberately
