...
TESTS
2722 / 2722 PASS across 154 files against a real local PostgreSQL 16.10 (up from 209 in the cloud
environment) -- 2703 passing plus 19 pinned `it.fails`, which are reproduced defects deliberately
