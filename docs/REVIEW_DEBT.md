...
| --------- | ----------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ------- |
| M01-M07   | DB schema + FRED/ECOS/DART/EDGAR adapter pattern + Event clustering     | No Codex session available in this environment yet                                                   | PENDING |
...
| M07       | No live news/metadata source wired; Claim Ledger has no real caller yet | Scoped out of this dev environment / deferred to M08 respectively — see PROJECT_STATE.md, CURRENT_TASK.md | PENDING |
